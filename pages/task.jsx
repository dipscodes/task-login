...
export default function CreateTask( {username, created} ) {
  ...
  const handleDuedate = (e) => {
    ...
    <Layout pageTitle="Create Task">
			<Link className="h-[50px] w-auto pt-10 text-2xl" href="/">Home</Link><br/>
			<h2 className="h-[50px] mt-5">Update Task</h2>
			<form action='/api/updateTask' method='POST'>
				...
				<input name="duedate" id="duedate" type="date" placeholder='Due Date' value={duedate} onChange={handleDuedate} required className="text-neutral-950 p-3 border-2 rounded-md mb-5"></input><br/>
